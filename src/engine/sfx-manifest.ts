...
export const SFX_MANIFEST = {
  ...
  pistolShot: entry('pistol-shot', 0.6),
  splat: entry('splat-1', 0.62, 0.06, 3),
  hit: entry('soft-hit', 0.42),
  hitConfirm: entry('soft-hit', 0.46),
  reload: entry('reload-end', 0.5),
  reloadStart: entry('reload-start', 0.48),
  reloadEnd: entry('reload-end', 0.55),
  respawn: entry('respawn-chime', 0.42, 0.025),
  door: entry('door-handle', 0.5),
  footstep: entry('footstep-1', 0.28, 0.06, 4),
  death: entry('splat-3', 0.72),
  knifeSwing: entry('knife-swing', 0.42),
  knifeHit: entry('splat-3', 0.7),
  weaponSwitch: entry('mechanical-click', 0.36),
  glassBreak: entry('glass-1', 0.65, 0.06, 2),
  shardTinkle: entry('shard-tinkle', 0.35),
  dryFire: entry('mechanical-click', 0.4),
